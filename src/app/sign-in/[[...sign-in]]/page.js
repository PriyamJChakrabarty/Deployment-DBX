  ...
  if (!hasClerkCredentials()) {
    return (
      <main style={shellStyle}>
        <ClerkSetupCard
          title="Sign in is waiting on your Clerk keys"
          message="Add the Clerk environment variables from the setup steps, then revisit /sign-in to use the hosted auth flow."
        />
      </main>
    );
  }
